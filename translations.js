const TRANSLATIONS = {
  en: {
    ...
    common: {
      ...
      chooseGroup: '👥 <b>Choose your group:</b>\n\nTap a button below.\nIf your group is missing, message @thcalmdx.',
  ...
  ru: {
    ...
    common: {
      ...
      chooseGroup: '👥 <b>Выберите свою группу:</b>\n\nНажмите на кнопку ниже.\nЕсли вашей группы пока нет, напишите @thcalmdx.',
...
const zhOverrides = {
  ...
  common: {
    ...
    chooseGroup: '👥 <b>请选择你的分组：</b>\n\n点击下方按钮。\n如果没有你的分组，请联系 @thcalmdx。',
    pickLanguage: '请选择语言：',
